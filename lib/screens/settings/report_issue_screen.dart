...
class _ReportIssueScreenState extends ConsumerState<ReportIssueScreen> {
  ...
  void initState() {
    super.initState();
    // Repaint once a second so the countdown stays accurate without re-querying.
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            Text(
              "Noticed a bug or have an idea? Submit it here — Claude gets a "
              '10-minute window to collect follow-ups before it files one '
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              '${batch.items.length} issue${batch.items.length == 1 ? '' : 's'} queued. Add more below to extend the window, or cancel.',
              style: Theme.of(context)
                  .textTheme
                  .bodySmall
                  ?.copyWith(color: cs.onSecondaryContainer),
