 ...
 *
 * Submissions are debounced: a user's first item opens a 10-minute window;
 * any further submission from the same user while the window is open appends
 * to the same batch and resets the clock. When the window closes, the whole
